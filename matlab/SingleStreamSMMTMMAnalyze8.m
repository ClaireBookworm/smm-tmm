...
% SMMTMM=readtable('SMMTMM_23OsMarch15.xlsx');
% SMMTMM(1:2,:)
% save SMMTMM
load SMMTMM
...
% blockstring=string(SMMTMM.blockName); % convert that column to a string
TestTrials=find(strcmp(SMMTMM.blockName,'Test')); % all the test lines
